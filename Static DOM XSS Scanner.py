...
if __name__ == '__main__':
    ...
    print '''Static DOM XSS Scanner is a Static Analysis tool that will iterate through all the JavaScript and HTML files under the given directory and will list out all the possible sources and sinks that may cause DOM XSS. At the end of the scan, the tool will generate an HTML report.\n'''
    main()
